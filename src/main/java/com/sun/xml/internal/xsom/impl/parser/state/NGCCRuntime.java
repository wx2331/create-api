/*     */ package com.sun.xml.internal.xsom.impl.parser.state;public class NGCCRuntime implements ContentHandler, NGCCEventSource { private Locator locator; private final Stack attStack; private AttributesImpl currentAtts; private StringBuffer text; private NGCCEventReceiver currentHandler; static final String IMPOSSIBLE = "\000"; private ContentHandler redirect; private int redirectionDepth; private final ArrayList namespaces;
...
/*     */   }
/*     */   
/* 123 */   public NGCCRuntime() { this.attStack = new Stack();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 140 */     this.text = new StringBuffer();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 478 */     this.namespaces = new ArrayList();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 498 */     this.nsEffectivePtr = 0;
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 503 */     this.nsEffectiveStack = new Stack();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/* 537 */     this.indent = 0;
/* 538 */     this.needIndent = true; reset(); }
...
/* Location:              C:\Program Files\Java\jdk1.8.0_211\lib\tools.jar!\com\sun\xml\internal\xsom\impl\parser\state\NGCCRuntime.class
