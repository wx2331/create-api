...
/* 171 */     if (this.v == null) return new Integer(this.$runtime.finalDefault);
/*     */     
/* 173 */     if (this.v.indexOf("#all") != -1) {
/* 174 */       return new Integer(3);
/*     */     }
/* 176 */     int r = 0;
/*     */     
/* 178 */     if (this.v.indexOf("extension") != -1) r |= 0x1; 
/* 179 */     if (this.v.indexOf("restriction") != -1) r |= 0x2;
/*     */     
...
/* Location:              C:\Program Files\Java\jdk1.8.0_211\lib\tools.jar!\com\sun\xml\internal\xsom\impl\parser\state\erSet.class
