...
/*    */   extends BinaryExpr
/*    */ {
/*    */   protected Times(Expression paramExpression1, Expression paramExpression2) {
...
/*    */           
/* 64 */           String[] arrayOfString = { Util.getMessage("EvaluationException.times"), left().value().getClass().getName(), right().value().getClass().getName() };
...
/* 71 */         value(bigInteger1.multiply(bigInteger2)); }
/*    */ 
/*    */     
/*    */     }
/* 75 */     catch (ClassCastException classCastException) {
/*    */       
/* 77 */       String[] arrayOfString = { Util.getMessage("EvaluationException.times"), left().value().getClass().getName(), right().value().getClass().getName() };
...
/* Location:              C:\Program Files\Java\jdk1.8.0_211\lib\tools.jar!\com\sun\tools\corba\se\idl\constExpr\Times.class
